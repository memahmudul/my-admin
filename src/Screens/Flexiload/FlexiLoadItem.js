...
import { removeFromRechargeOrderList } from '../../reduxtooolkit/orderSlice';
import { showError, showSuccess } from '../../utils/helperFunction';

// create a component
const FlexiLoadItem = ({item,commission}) => {
    ...
    Alert.alert('Failed Recharge Order', 'Are you sure you want to make it failed?', [
        {text: 'Cancel', onPress: () => console.log('Cancel Pressed')},
      {
        ...
        onPress: async() => {
            ...
            if(result[0]==='perform-transaction-success'){
                dispatch(removeFromRechargeOrderList(id))
    ...
    return (
        ...
        adminName===item.admin? <View style={styles.container}>
